    ...
    if (!localUpd) {
      notification.open({
        ...
        description: (
          ...
          >
            We would like to know you thoughs about CrownLabs! Please fill{' '}
            <a target="_blank" href="https://forms.gle/g86xkWTHoaULfPHp8">
              this form
            </a>
            !
            <br /> If you would like to keep know the latest news of CrownLabs,
            join our{' '}
